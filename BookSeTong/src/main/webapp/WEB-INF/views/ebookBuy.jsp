...
function ebookBuyOk(email,point){
	...
	if(point>= 0){
		...
		if(flag==true){
			...
			ff.action="updateBmoney.bir?email="+email+"&point="+point;
			ff.submit();
		}else{
			ff = document.getElementById("f");
...
<center>
<img src="resources/img/ebuy_btn.png" onclick="ebookBuyOk('${vo2.email}',${vo2.point-vo1.eb_price})">
