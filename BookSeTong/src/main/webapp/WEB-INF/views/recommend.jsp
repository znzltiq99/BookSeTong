...
<body>
	...
	<div class="green">
		<form id="checkbox">
			...
			<div style="font-size: 12px">
				<input type="radio" name="chk">자기계발</input> <input type="radio" name="chk">경제/경영</input>
				<input type="radio" name="chk">예술/대중문화</input> <input type="radio" name="chk">과학</input>
				<input type="radio" name="chk">에세이</input> <input type="radio" name="chk">정치/사회</input>
				<input type="radio" name="chk">기술공학</input> <input type="radio" name="chk">시</input>
				<input type="radio" name="chk">IT</input> <input type="radio" name="chk">여행</input>
				<input type="radio" name="chk">어린이</input> <input type="radio" name="chk">종교</input>
				<input type="radio" name="chk">인문</input>
			</div>
			<h5>&nbsp;▶소설</h5>
			<div style="font-size: 12px">
				<input type="radio" name="chk">SF/판타지</input> <input type="radio" name="chk">전쟁</input>
				<input type="radio" name="chk">무협</input> <input type="radio" name="chk">공포/추리</input>
	</input> <input type="radio" name="chk">로맨스</input>
				<input type="radio" name="chk">역사</input> <a href="#"><div
						id="search_btn"></div></a>
	...
	<div class="tabs">이 태그 사이에 이미지 넣으면 됨</div>
